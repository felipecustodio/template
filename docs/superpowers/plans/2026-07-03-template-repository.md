...
- [x] **Step 1: Add failing Karva tests**
...
- [x] **Step 2: Define backend package**
...
- [x] **Step 3: Lock and sync dependencies**
...
- [x] **Step 5: Implement Pydantic model and Robyn route**
...
- [x] **Step 1: Define package and strict compiler settings**
...
- [x] **Step 5: Implement browser placeholder**
...
- [x] **Step 1: Extend failing contract tests**
...
- [x] **Step 3: Add pinned tools and tasks**
...
- [x] **Step 5: Lock and verify tools**
...
- [x] **Step 1: Extend failing workflow tests**
...
- [x] **Step 4: Validate workflow and aggregate CI**
...
- [x] **Step 1: Write README contract test**
...
- [x] **Step 4: Audit objective requirement by requirement**
